...
void Demo::Render() {
	...
	DrawTvDepan(this->depthmapShader);
	DrawTvSamping(this->depthmapShader);
	DrawTvBelakang(this->depthmapShader);
	...
	DrawTvDepan(this->shadowmapShader);
	...
	glActiveTexture(GL_TEXTURE1);
	glBindTexture(GL_TEXTURE_2D, depthMap);
	DrawTvBelakang(this->shadowmapShader);
	...
	glActiveTexture(GL_TEXTURE1);
	glBindTexture(GL_TEXTURE_2D, depthMap);
	DrawTvSamping(this->shadowmapShader);
...
void Demo::DrawTvDepan(GLuint shader)
{
	UseShader(shader);
	glBindVertexArray(VAO);
	glm::mat4 model;
...
void Demo::DrawTvSamping(GLuint shader)
{
	UseShader(shader);
	glBindVertexArray(VAO3);
	glm::mat4 model;
...
void Demo::DrawTvBelakang(GLuint shader)
{
	UseShader(shader);
	glBindVertexArray(VAO4);
	glm::mat4 model;
